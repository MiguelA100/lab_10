...
class AddPlacesTestTitleTest(LiveServerTestCase):
    ...
    def test_add_new_place(self):
        ...
        self.assertIn('Denver', self.selenium.page_soure)
        self.assertIn('New York', self.selenium.page_soure)
        self.assertIn('Tokyo', self.selenium.page_soure)
